...
if __name__ == '__main__':
    ...
    h2o.init(ip="localhost", port=54323, max_mem_size = "20G", nthreads=-1)
    ...
    # X_train, X_valid, y_train, y_valid = train_test_split(X_train, X_test, test_size=0.25, random_state=0)

    # X_train['ccause_type'].to_csv('.\\testing1.csv')
    # X_test['ccause_type'].to_csv('.\\testing2.csv')


    # default ntrees=50, max_depth=5, stopping_rounds=0
    params = {
        'model_id':"gbm_covType_v1",
        'ntrees':500, 'max_depth':9,
        'learn_rate':0.1, 'stopping_metric':'mae',
